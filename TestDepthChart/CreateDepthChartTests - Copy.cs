...
namespace TestDepthChart
{
    ...
    {
        [Fact]
        public void AddPlayerToDepthChartTest1()
        {
        ...
        [Fact]
        public void AddPlayerToDepthChartTest2()
        {
            ICreateDepthChart objTest = new CreateDepthChart();
        ...
        [Fact]
        public void AddPlayerToDepthChartTest3()
        {
            ICreateDepthChart objTest = new CreateDepthChart();
            string position3 = "QB";
        ...
        [Fact]
        public void AddPlayerToDepthChartTest4()
        {
            ICreateDepthChart objTest = new CreateDepthChart();
            string position4 = "QB";
        ...
        [Fact]
        public void AddPlayerToDepthChartTest5()
        {
            ICreateDepthChart objTest = new CreateDepthChart();
        ...
        [Fact]
        public void AddPlayerToDepthChartTest6()
        {
            ICreateDepthChart objTest = new CreateDepthChart();
